...
public class PdfPTableUtility {
     ...
     */
    public static PdfPCell createPdfPCell(int colspan, int rowspan, String str, Font font, float borderWidth,
     ...
     * @return <code>PdfPCell</code> 物件，若傳入的 <code>str</code> 是 <code>null</code> 則會回傳一個無內容的 <code>PdfPCell</code> 物件
     */
    public static PdfPCell createPdfPCell(int colspan, int rowspan, String str, FontSelector fontSelector,
                                          float borderWidth, int borderType, int hAlignment, int vAlignment,
                                          int lineSpace) {
     ...
     */
    public static PdfPCell createPdfPCell(int colspan, int rowspan, Image image, float borderWidth, int borderType,
     ...
     */
    public static PdfPCell createPdfPCell(int colspan, int rowspan, String str, Font font, float borderWidth,
                                          int borderType, int hAlignment, int vAlignment, int lineSpace, int padding) {
        PdfPCell cell = new PdfPCell(new Phrase(StringUtils.defaultString(str), font));
