...
public class PdfUtility {
     ...
     */
    public static byte[] templateReport(byte[] templateFile, String[] fieldNames,
                                        List<String> fieldValues) throws ReportException {
        try {
     ...
     * @throws ReportException
     */
    public static void templateReport(byte[] templateFile, String[] fieldNames, List<String> fieldValues,
                                      PdfSmartCopy copy) throws ReportException {
        try {
            if (fieldNames == null || fieldValues == null || fieldNames.length == 0 || fieldValues.size() == 0)
                throw new ReportException("套表之欄位名稱及欄位值 List 不得為 null");
     ...
     * @throws ReportException
     */
    public static byte[] templateReport(byte[] templateFile, List<String> fieldNames,
                                        List<String> fieldValues) throws ReportException {
        try {
            ...
            for (int i = 0; i < fieldNames.size(); i++) {
                form.setField(StringUtils.defaultString(fieldNames.get(i)),
                        StringUtils.defaultString(fieldValues.get(i)));
            }
     ...
     * @throws ReportException
     */
    public static void templateReport(byte[] templateFile, List<String> fieldNames, List<String> fieldValues,
                                      PdfSmartCopy copy) throws ReportException {
        try {
            if (fieldNames == null || fieldValues == null || fieldNames.size() == 0 || fieldValues.size() == 0)
                throw new ReportException("套表之欄位名稱及欄位值 List 不得為 null");
     ...
     * @throws ReportException
     */
    public static void templateReport(byte[] templateFile, HashMap<String, String> map,
                                      PdfSmartCopy copy) throws Exception {
        try {
            if (map == null)
    ...
    public static byte[] lockFileReadOnly(byte[] file, String userPassword, int encryption) throws ReportException {
        try {
            ...
            PdfReader reader = new PdfReader(file);
            PdfStamper stamper = new PdfStamper(reader, outFile);
            stamper.setEncryption(userPass, ownerPass, PdfWriter.ALLOW_SCREENREADERS,
                    encryption | PdfWriter.DO_NOT_ENCRYPT_METADATA);
            stamper.close();
            reader.close();
            outFile.close();
     ...
     * @throws ReportException
     */
    public static List<byte[]> splitFile(byte[] pdfFile, int pagesPerFile, int fromPage,
                                         int toPage) throws ReportException {
        try {
            if (pdfFile == null)
                return null;
     ...
     * @throws ReportException
     */
    public static void splitFile(byte[] pdfFile, String outputPath, String fileName,
                                 int pagesPerFile) throws ReportException {
        try {
            if (pdfFile == null)
                return;
     ...
     * @throws ReportException
     */
    public static void splitFile(byte[] pdfFile, String outputPath, String fileName, int pagesPerFile, int fromPage,
                                 int toPage) throws ReportException {
     ...
     * @throws ReportException
     */
    public static byte[] mergeFile(byte[] file1, byte[] file2, int fromFile1Page,
                                   int fromFile2Page) throws ReportException {
        try {
            if (file1 == null && file2 == null)
                return null;
            else if (file1 == null)
     ...
     * @throws ReportException
     */
    public static byte[] mergeFile(byte[] file1, byte[] file2, int fromFile1Page, int toFile1Page, int fromFile2Page,
                                   int toFile2Page) throws ReportException {
        try {
            if (file1 == null && file2 == null)
                return null;
            else if (file1 == null)
