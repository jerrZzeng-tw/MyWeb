...
public class ValidateUtility {
     ...
     * 身分證號有效字元檢查，外籍不檢查
     *
     * @param idNo,nationtpe
     * @return
     */
    public static boolean validIdNoCharIfNotForeign(String idNo) {

        return isValidIdNoChar(idNo);
    }
     ...
     * @return
     */
    public static boolean isValidPeriod(String sDate, String eDate) {
