package tw.gov.idb.base.job.util;
...
public class CronExpressionUtility {
     ...
     * @return
     */
    public static String generateCronExr(String year, String dayOfWeek, String month, String dayOfMonth, String hours,
        ...
        if (StringUtils.isBlank(month)) {
            ...
            if (StringUtils.equals(begin, "*"))
                cron.withMonth(every(Integer.parseInt(end)));
            else
                cron.withMonth(every(on(Integer.parseInt(begin)), Integer.parseInt(end)));
        } else {
        ...
        if (StringUtils.isBlank(dayOfMonth)) {
            ...
            if (StringUtils.equals(begin, "*"))
                cron.withDoM(every(Integer.parseInt(end)));
            else
                cron.withDoM(every(on(Integer.parseInt(begin)), Integer.parseInt(end)));
        } else {
        ...
        if (StringUtils.isBlank(hours)) {
            ...
            if (StringUtils.equals(begin, "*"))
                cron.withHour(every(Integer.parseInt(end)));
            else
                cron.withHour(every(on(Integer.parseInt(begin)), Integer.parseInt(end)));
        } else {
        ...
        if (StringUtils.isBlank(minutes)) {
            ...
            if (StringUtils.equals(begin, "*"))
                cron.withMinute(every(Integer.parseInt(end)));
            else
                cron.withMinute(every(on(Integer.parseInt(begin)), Integer.parseInt(end)));
        } else {
        ...
        if (StringUtils.isBlank(seconds)) {
            ...
            if (StringUtils.equals(begin, "*"))
                cron.withSecond(every(Integer.parseInt(end)));
            else
                cron.withSecond(every(on(Integer.parseInt(begin)), Integer.parseInt(end)));
        } else {
