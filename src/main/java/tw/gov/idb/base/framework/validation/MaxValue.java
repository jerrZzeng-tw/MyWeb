...
import tw.gov.idb.base.framework.validation.validators.MaxValueValidatorForCharSequence;
import tw.gov.idb.base.framework.validation.validators.MaxValueValidatorForNumber;
...
public @interface MaxValue {
    ...
    String message() default "{validation.maxValue.message}";
