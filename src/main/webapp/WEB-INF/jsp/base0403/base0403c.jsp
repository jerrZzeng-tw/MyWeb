...
<html>
<head>
    <acl:setProgId progId="BASE0403C"/>
        ...
        <div class="content">
            ...
            <div class="page">
                <div class="main">
                    ...
                    <div class="fieldset">
                        <div class="legend">角色管理-BASE0403C</div>
                        <div class="timeword">
                            網頁下載時間：民國&nbsp;
                            <func:nowDateTime/>
                        </div>
                        ...
                        <fieldset>
                            ...
                            <c:if test="${base0403.status == 'add'}">
                                <table class="form-table mx-auto">
                                    <tr>
                                        <th width="40%" class="star">角色ID：</th>
                                        <td width="60%">
                                            <form:input path="roleId" type="text" class="textinput" size="14"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th width="40%" class="star">角色名稱：</th>
                                        <td width="60%">
                                            <form:input path="roleName" type="text" class="textinput" size="14"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th width="40%">角色說明：</th>
                                        <td width="60%">
                                            <form:input path="roleDesc" type="text" class="textinput" size="14"/>
                                        </td>
                                    </tr>
...
<script>
    $(document).ready(function () {
        ...
        $('#addBtn').click(function () {
            $('#sessionForm').attr('action', '<c:url value="/base0403_add.action" />').submit();
        });

        $('#updBtn').click(function () {
            $('#sessionForm').attr('action', '<c:url value="/base0403_upd.action" />').submit();
        });
